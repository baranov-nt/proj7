...
<div class="container" style="padding-top: 20px;">
    <div class="row">
        ...
        <div class="col-md-12 text-center" style="margin-bottom: 20px;">
            <?= Html::a('Сайт', ['/works/element-site'], ['class' => 'btn btn-sm btn-default']) ?>
            <?= Html::a('Продвижение', ['/works/element-promotion'], ['class' => 'btn btn-sm btn-warning']) ?>
        </div>
        ...
        <div class="col-xs-8 col-sm-4 vcenter">
            ...
            echo Carousel::widget([
                'items' => [
                    '<img style="width: 100%" src="'.Yii::$app->urlManager->baseUrl.'/images/Carousel/carousel_21.jpg'.'"/>',
                    '<img style="width: 100%" src="'.Yii::$app->urlManager->baseUrl.'/images/Carousel/carousel_22.jpg'.'"/>',
                    '<img style="width: 100%" src="'.Yii::$app->urlManager->baseUrl.'/images/Carousel/carousel_23.jpg'.'"/>',
                ],
